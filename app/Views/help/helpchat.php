<div class="fixed right-0 mr-3 bottom-0 p-7">
  <!-- Author: FormBold Team -->
  <!-- Learn More: https://formbold.com -->
  <div class="w-full ">
    <div class="formbold-form-wrapper mx-auto hidden w-full max-w-[550px] rounded-lg shadow-xl backdrop-blur-sm">

      <form action="https://formbold.com/s/FORM_ID" method="POST" class="py-6 px-9">
        <div class="mb-5">
          <label for="name" class="mb-3 block text-base font-medium text-[#07074D]">
            Your Name
          </label>
          <input type="text" name="name" id="name" placeholder="ENter your name" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
        </div>
        <div class="mb-5">
          <label for="message" class="mb-3 block text-base font-medium text-[#07074D]">
            Message
          </label>
          <textarea rows="4" name="message" id="message" placeholder="Explain your queries" class="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
        </div>
        <div>
    ...
    <div class="mx-auto mt-1 flex max-w-[550px] items-center justify-end space-x-5">
      <button class="flex h-[46px] w-[46px] items-center justify-center rounded-full bg-[#6A64F1] text-white" onclick="chatboxToogleHandler()">
